...
export const workerFilterSchema = baseFilterSchema.extend({
  availableAt: z.iso.datetime({ message: 'Invalid datetime format' }).optional(),
...
export type CheckWorkerAvailabilityInput = z.infer<typeof checkWorkerAvailabilitySchema>;
