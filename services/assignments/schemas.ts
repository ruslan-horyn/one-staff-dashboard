...
export const createAssignmentSchema = z
  .object({
    ...
    endAt: z.iso.datetime({ message: 'Invalid end datetime format' }).optional().nullable(),
  })
  .refine(
    (data) => {
      if (data.endAt) {
...
export type WorkerAssignmentsFilter = z.infer<typeof workerAssignmentsFilterSchema>;
